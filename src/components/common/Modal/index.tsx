...
const Modal = ({
  ...
  return (
    <div
      ...
      onClick={() => handleClose()}
    >
      <div className="flex min-h-screen items-center justify-center py-[10px] px-[8px] backdrop-blur-sm">
        <div
        ...
        >
          {title && <h3 className="mb-[16px] text-[24px] font-semibold">{title}</h3>}
          {!hideCloseIcon ? (
            <div
